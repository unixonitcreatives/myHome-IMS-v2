...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $po_qty                       = test_input($_POST['po_qty']);
  $po_unit                      = test_input($_POST['po_unit']);
  $po_description               = test_input($_POST['po_description']);
  $po_unit_price                = test_input($_POST['po_unit_price']);
  $po_total_amount              = test_input($_POST['po_total_amount']);
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <form class="form-vertical" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="createOrderForm">
                <h3 class="box-title">Supplier: <input type="text" name="supplier_name" value="<?php echo $supp; ?>" readonly/></h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
