...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  $so_date                =test_input($_POST['so_date']);
...
//INSERT query
  $query = "INSERT INTO so_transactions (so_trans_id, so_date, so_customer_name, so_sub_total, so_paymentTerms, so_delivery_fee, so_discount, so_grand_total, remarks) VALUES ( $so_trans_id, $so_date, $so_customer_name, $so_sub_total, $so_paymentTerms, $so_delivery_fee, $so_discount, $so_grand_total, $so_remarks )";
  $result = mysqli_query($link, $query) or die(mysqli_error($link));

  if ($result) {
    $j = 0;

    $count = sizeof($_POST['model']);
    ...
    for ($j = 0; $j < $count; $j++) {
      ...
      $query = "INSERT INTO so_items (so_trans_id, so_model, so_qty, so_unit, so_unit_price, so_total_amount,user) VALUES (
        '".$po_trans_id."',
        '".$_POST['so_model'][$j]."',
        '".$_POST['so_qty'][$j]."',
        '".$_POST['so_unit'][$j]."',
